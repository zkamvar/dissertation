...
\mainmatter
  ...
  from (Grünwald et al., \protect\hyperlink{ref-Grunwald:2003}{2003}).
  \texttt{N}: census size, \texttt{MLG}: multilocus genotypes,
  \texttt{eMLG}: expected MLG based on rarefaction, \texttt{SE}: standard
  error from rarefaction, \texttt{H}: Shannon-Wiener Index, \texttt{G}:
  Stoddart and Taylor's Index, \texttt{Hexp}: Nei 1978 Expected
  Heterozygosity, \texttt{E.5}: Evenness (\(E_5\)), \texttt{Ia}: \(I_A\),
  \texttt{p.Ia}: p-value for \(I_A\), \texttt{rbarD}: \(\bar{r}_d\),
  \texttt{p.rD}: p-value for \(\bar{r}_d\). Table was obtained with the
  following code:
  ...
  \protect\hyperlink{ref-Jombart:2008}{2008}) (a) and for the clonal
  \texttt{Athena} population of the \texttt{Aeut} data set (Grünwald et
  al., \protect\hyperlink{ref-Grunwald:2003}{2003}) (b).}\label{fig:poppr2}
  \end{figure}
  ...
  al.,
  \protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b}).
  For populations with well-defined sexual and clonal phases occurring at
  separate times, methods like \emph{CloNcaSe} are effective for
  ...
  when sexual reproduction is not a cyclical phenomena, this estimator is
  useless. Currently, a method commonly used to assess clonal reproduction
  is the index of assocation (\(I_A\)), and its standardized version,
  ...
  Smith et al.,
  \protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b}).
  The value of \(I_A\) is measured as the ratio of observed variance in
  genetic distance between samples (\(V_O\)) and expected variance
  (\(V_E\)) (equation \eqref{eq:ia}) (Agapow and Burt,
  \protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a};
  Smith et al.,
  \protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b}).
  ...
  \protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a};
  Haubold et al., \protect\hyperlink{ref-haubold1998detecting}{1998}). If
  the differences between samples are randomly distributed, we can expect
  the value of \(I_A\) to be zero (Agapow and Burt,
  \protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a};
  Smith et al.,
  \protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b}).
  Under scenarios of non-random mating (e.g.~population structure or
  clonal reproduction), the observed variance would be greater than the
  expected due to a bimodal distribution of distances, and \(I_A\) would
  be greater than zero (Agapow and Burt,
  \protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a};
  ...
  Agapow and Burt
  (\protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a})
  noted that this metric does not have an upper limit and increases with
  the number of loci. To correct this, they developed \(\bar{r}_d\)
  (equation \eqref{eq:rd}), which has a similar structure to a correlation
  coefficient and ranges from 0 (no linkage) to 1 (complete linkage).
  ...
  Smith et al.
  (\protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b})
  demonstrated that \(I_A\) has the ability to detect non-random mating
  due to population structure, strict clonal reproduction, or a recent
  epidemic, but at that time, no one had quantified how much clonal
  reproduction had to occur to produce a significant value of \(I_A\).
  This was of significant concern, considering that, as with any summary
  statistic, a lot of information is lost when evaluating a population
  based on \(I_A\) (Brown et al.,
  \protect\hyperlink{ref-brown1980multilocus}{1980}\protect\hyperlink{ref-brown1980multilocus}{b}).
  One way to assess the effect of different population genetic scenarios
  was via simulations.
  ...
  (Agapow and Burt,
  \protect\hyperlink{ref-Agapow_2001}{2001}\protect\hyperlink{ref-Agapow_2001}{a};
  de Meeûs and Balloux, \protect\hyperlink{ref-de2004clonal}{2004}; Kamvar
  et al.,
  \protect\hyperlink{ref-kamvar2014poppr}{2014}\protect\hyperlink{ref-kamvar2014poppr}{b};
  ...
  Smith et al.,
  \protect\hyperlink{ref-smith1993how}{1993}\protect\hyperlink{ref-smith1993how}{b}).
  A one-sided \emph{t}-test of significance was then used to see if the
  observed statistic was greater than the observed distribution.
