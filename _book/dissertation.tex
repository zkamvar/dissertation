...
\mainmatter
  ...
  Population genetic theory is largely based on 
  model populations such as the neutral Wright-Fisher model in which populations are infinitely large, with discrete
  ...
  modeld, population geneticists are able to ask fundamental questions and
  test hypotheses about which evolutionary processes might have resulted in the obersved patterns.
  
  These neutral models, however, cannot be applied to populations whose life
  history violate the fundamental assumption of random assortment of
