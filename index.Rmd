...
# this YAML header.
bibliography: ['bib/references.bib', 'bib/thesis.bib', 'bib/fronteirs_citations.bib']
...
if(!require(thesisdown))
  devtools::install_github("zkamvar/thesisdown@osu-thesis")
library(thesisdown)
```
...
template][0] and wrapped up into Chester Ismay's [*thesisdown* package][1], but
...
[1]: https://github.com/ismayc/thesisdown
