...
With the advent of molecular markers, it was possible to address these questions
in a population genetic context [@milgroom1997contributions; 
@tibayrenc1995population; @mcdonald1997population]. Genetic markers that are
selectively neutral can reveal information about population size and
subdivision, and selected markers can reveal information about the evolutionary
potential of the population [@milgroom1997contributions; 
@mcdonald1997population; @tibayrenc1995population]. Importantly, markers must be
independent from one another, that is, they must be genetically unlinked
