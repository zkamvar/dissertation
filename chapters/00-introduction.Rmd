...
@heitman2012evolution; @arnaud2012implications; @orive1993effective]. Clonal
reproduction here means reproduction that results in the offspring is
genetically identical to the parent (note that this can include organisms
derived from selfing in a haploid organism).
