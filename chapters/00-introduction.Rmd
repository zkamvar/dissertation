...
County, OR outbreak of the sudden oak death pathogen, *Phytophthora ramorum*. 
We additionally assess the power of the multilocus linkage disequilibrium
measure $\bar{r}_d$ to detect clonal reproduction.
...
that sex occurs in all organisms as many plants, fungi, protists, bacteria,
...
simply indicate a group of individuals of the same species coexisting in the
...
reproductive strategies in an evolutionary perspective. For organisms whose main
...
Before molecular techniques were widely available, however, the variation within
most pathogenic microorganisms was described using phenotypic traits that
reflected their pathogenicity (ability to cause disease) and virulence (severity
of disease), placing them into different pathotypes [@milgroom1997contributions;
...
degree. The problem with pathotypes was that, while it was possible to define a
...
variables that can reflect the degree of population size, subdivision, and
migration. For selectively neutral markers, it is important that they be
independent and unlinked within the genome [@mcdonald1997population].
...
markers due to recombination. This contrasts with clonal reproduction, which
...
of potato late blight (and poster child for plant pathology), *P. infestans* has
...
potato [@piepenbring2015infestans]. M! = meiosis, P! = plasmogamy, K! = karyogamy"
...
operating platforms [@excoffier2006computer; @kamvar2014poppr]. The constant
...
for error [@excoffier2006computer; @kamvar2014poppr; @goecks2010galaxy].
...
our downstream analyses. This work attempts to introduce tools for reproducible
...
over unlimited levels of user-specified population hierarchies
...
to perform power analyses. We used *poppr* to investigate the power of the index
