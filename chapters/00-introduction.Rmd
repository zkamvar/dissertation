...
genetics. This statement is slightly erroneous, however, as the questions asked
are often a product of the answers interpreted from the results given by the
tools used. In this sense, the tools are just as important as the questions.
...
```{r, introduction1, echo = FALSE, fig.cap = figcap1, fig.scap = figscap1}
