...
These tools, however, should not simply be seen as a means to an end of simply
...
data sets produce the exact same result (slope, intercept, variance,
correlation) via linear regression. Upon visual inspection, it's clear that they
...
Anscombe's quartet was initially published to demonstrate the need for
visualization of statistical analyses in 1973, a period in which the end user
had to write a program for visualization [@anscombe1973graphs]. If we imagine
each data set as separate population and linear regression as our molecular
marker, it wouldn't matter what our question was, because there would be no hope
...
Bioinformatics is a discipline in and of itself centered around tools [@searls2010roots]. 
