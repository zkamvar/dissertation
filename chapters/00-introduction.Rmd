...
In plant pathology many of the diseases are caused by fungi or oomycetes. With
few exceptions, these organisms have the ability to undergo both sexual and
asexual reproduction [@heitman2012evolution; @nieuwenhuis2016frequency]. 
Oomycetes are generally diploid, but fungi can be haploid, diploid, dikaryotic,
or heterokaryotic. 


Beyond increasing genotypic diversity sexual reproduction often confers another
advantage to pathogen populations: survival. For several species of plant
pathogenic fungi and oomycetes, sexual reproduction produces specialized spores
that have the ability to survive in the soil for several years
[@mcdonald2002pathogen]. This, in combination with the increase in genotypic
diversity makes understanding the reproductive strategy of plant pathogens ever
more important. Here, I will review how agricultural ecosystems promote pathogen
evolution and then give two examples of how the use of population genetic theory
and detection of sexual reproduction has helped researchers manage black stem
rust of wheat and potato late blight.
...
An example of a successful management strategy concerning mitigating the effects
of sexual reproduction is that of the wheat stem rust pathogen, *Puccinia 
graminis* [@roelfs1982effects; @schumann2000stem]. This disease produces
pustules of clonally derived spores on the leaves and the stems of their hosts,
rapidly spreading and reducing yield. This fungus is an obligate biotroph with a
heteroecious life cycle, meaning that it requires two live hosts to complete its
life cycle, wheat and barberry [@schumann2000stem; @roelfs1982effects]. It is on
barberry that *P. graminis* completes its sexual cycle, producing new genotypes
that have a greater potential to overcome the resistance of wheat plants 
[@roelfs1982effects; @schumann2000stem; @mcdonald2002pathogen]. An epidemic of
stem rust in 1916 promoted an effort to eradicate barberry from wheat growing
regions [@roelfs1982effects]. By taking away the potential for sexual 
recombination, the number of *P. graminis* strains declined three fold from 1918
to 1977 and the [@roelfs1982effects]. 
