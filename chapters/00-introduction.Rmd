...
I put this as a comment since it's a guideline
 ...
 - Plant Pathogens
 	...
 	- Understanding clonal population dynamics (*Phytophthora* and
 	  *Zymoseptoria* examples)
 - Tools for analysis
...
The majority of plant pathogenic species on earth are microbial. The majority of
these microbes have the ability to reproduce both sexually and clonally, which
allows them to adapt to their environment in different ways. Sexual reproduction
can purge deleterious alleles and create potentially more fit combinations of
genes, which could guard against future plant defenses and pesticides, but at
the risk of losing currently advantageous gene combinations. Clonal reproduction
allows them to hold on to their unique combination of virulence genes at the
cost of genetic variation.
