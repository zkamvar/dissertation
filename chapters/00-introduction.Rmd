...
and viruses are known to exclusively reproduce clonally [@rice2002evolution;
@heitman2012evolution; @arnaud2012implications; @orive1993effective; 
@arnaud2007standardizing]. Clonal reproduction here means reproduction that
results in offspring that are genetically identical to the parents (note that
this can include organisms derived from selfing in a haploid organism). There
are several costs and benefits associated with both clonal and sexual
reproductive strategies in an evolutionary perspective. 
...
recombination [@heitman2012evolution; @nieuwenhuis2016frequency]. The advantage
...
mate [@heitman2012evolution]. The balance of costs and benefits in organisms
that undergo either sexual or clonal reproduction is based on adaptation for the
present or adaptation for the future.
