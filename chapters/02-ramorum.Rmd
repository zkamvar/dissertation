...
found in the supplementary text \@ref(text:S1) and figure S\@ref(fig:ramS1).
...
enough power in our data to describe a significant number of MLGs (Fig. S\@ref(fig:ramS2)).
...
does show that these tend to cluster by region as opposed to year (Fig. S\@ref(fig:ramS3)).
...
(Fig. S\@ref(fig:ramS4)). The isolation of the Hunter Creek isolates in the DAPC analysis was
found to be mainly driven by allele 493 at locus PrMS43 (Fig. S\@ref(fig:ramS5)). The only
...
decrease of 17.6% when nursery populations were included (Fig. S\@ref(fig:ramS4)). Prediction
...
$\geq$ 95% probability (Fig. S\@ref(fig:ramS6), S\@ref(fig:ramS7)). A total of 3.2% of the isolates were
...
probability (Fig. S\@ref(fig:ramS8)). No Hunter Creek isolate was predicted to share membership
...
California nurseries (Fig. S\@ref(fig:ramS8)). This, in combination with the observation that
...
over time (Fig. S\@ref(fig:ramS9), S\@ref(fig:ramS10)). This, along with the results from the DAPC clustering
and subsequent prediction (Fig. S\@ref(fig:ramS6), S\@ref(fig:ramS7)) provide weak support for a potential
...
```{r, avolcano, fig.cap = "HOT LAVA"}
image(volcano, col = viridis::viridis_pal(option = "A")(100))
```