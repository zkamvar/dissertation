...
```{r, ramorum1, echo = FALSE, fig.cap = paste(figcap1), fig.scap = paste(figscap1)}
...
1.4.2 (Figure 5). AMOVA utilizes a distance matrix between genotypes for
...
\@ref(fig:ramorum1); Table 1). To date a total of 70 multilocus genotypes have been found
...
```{r, ramorum2, echo = FALSE, fig.cap = paste(figcap2), fig.scap = paste(figscap2), out.width = "40%"}
...
```{r, ramorum3, echo = FALSE, fig.cap = paste(figcap3), fig.scap = paste(figscap3)}
...
```{r, ramorum4, echo = FALSE, fig.cap = paste(figcap4), fig.scap = paste(figscap4)}
