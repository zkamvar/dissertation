...
(Table \@ref(tab:ramtab4)). Significant structure was only found between years within
...
minimum spanning network and DAPC scatter plot (Fig. \@ref(fig:ramorum3), \@ref(fig:ramfig4)) suggest that
...
across regions (Table \@ref(tab:ramtab4)). The populations sampled in 2011 in Hunter
Creek (Cape Sebastian) appear to have originated from a new source and
cluster into a distinct group based on DAPC (Fig. \@ref(fig:ramfig4)). Based on the
...
Creek isolates adjacent to the nursery isolates from CA (Fig. \@ref(fig:ramfig4), \@ref(fig:ramorum5)).
