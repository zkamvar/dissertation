...
```{r, Figure-2, echo = FALSE, message = FALSE, out.width = "0.5\\linewidth", fig.width = 4*1.25, fig.height = 4*1.25, fig.cap = "Filtered multilocus genotypes"}
library('poppr')
library('ape')
library('phangorn')
...
**Figure 2** Graphical representation of three different clustering algorithms
...
```{r, Figure-3, out.width = "0.5\\linewidth", echo = FALSE, fig.cap = "Reticulated Minimum Spanning Network"}
