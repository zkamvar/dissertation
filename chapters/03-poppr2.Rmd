...
```{r, Figure-4, cache = FALSE, results = "hide", ref.label = "microboot", message = FALSE, echo = FALSE, fig.width = 5, fig.height = 5, fig.cap = paste(figcap4), fig.scap = paste(figscap4)}
```


\newpage

```{r, Figure-5, cache = FALSE, results = "hide", ref.label = "monilinia_curve", echo = FALSE, fig.width = 5, fig.height = 5, fig.keep = "last", message = FALSE, fig.cap = paste(figcap5), fig.scap = paste(figscap5)}
...
res[res == 0] <- "."
cap <- "Contingency table comparing multilocus lineages assigned based on
...
knitr::kable(t(res), align = "c", format = "latex")
