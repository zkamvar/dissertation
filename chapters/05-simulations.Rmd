...
@nielsen2013introduction]. By using this model, population geneticists are able to
...
cap <- "Violin plots showing the decay of the Index of Association measured
with declining rates of sexual reproduction for data sets simulated with even
and uneven mutation rates over 20 and 21 loci, respectively. $\\bar{r}_d$ was
calculated for both whole and clone corrected data sets. Each violin plot
contains 1000 unique data sets. Black lines mark the 25, 50, and 75th
percentile."
