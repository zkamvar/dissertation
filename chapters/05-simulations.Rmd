...
to sample size, mutation rate, and clone-correction. After dividing data sets by
mutation rate and rate of sexual reproduction, we used ANOVA to test if the
means of the distributions were significantly different from each other based on
sample size and clone correction.
