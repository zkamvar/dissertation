...
Given the promise of being able to detect linkage in populations, @de2004clonal
investigated the effect of increasing levels of sexual reproduction on
$\bar{r}_d$ (noted in their publication as $\bar{r}_D$), finding that it
increased in variance with decreasing rates of sexual reproduction.
