...
The standardized index of association is a measure of multilocus linkage
disequilibrium that is analogous to a correlation coefficient among loci in a
population and is often used to give support for the hypothesis of clonal
reproduction in populations. Previous studies have shown that it decays rapidly
with increasing rates of sexual reproduction (> 1%) and exhibits high variance
in populations with strict clonal reproduction. We aim to assess how marker
choice, sample size, mutation rate, and clone-correction affect inference of
clonal reproduction with the standardized index of association in diploid
populations. We simulated populations with microsatellite and SNP markers and
found that power to detect clonal reproduction decreases with small sample sizes
and low allelic diversity. This work provides information that is useful for 
population geneticists analyzing clonal populations.
...
increase in false positive rates (Fig. \@ref(fig:sim6)). An AMOVA
...
uncorrected data [@smith1993how; @mcdonald1997population]. When analyzing
...
Our results largely confirmed the results of @de2004clonal, which showed large
variances in $\bar{r}_d$ for clonal populations and near-zero values of
$\bar{r}_d$ at rates of sexual reproduction > 1% (Fig. \@ref(fig:sim1)). A novel
feature that we found in our results not present in @de2004clonal was the 
presence of negative values of $\bar{r}_d$. While positive values of $\bar{r}_d$
...
*Puccinia graminis* f.sp. *tritici* (Les Szabo, pers. comm.). We observed a
common pattern in all of these populations in that they all had values of 
$E_5A$ > 0.9 and an average of fewer than 4 alleles per locus. This is reflected
...
to the microsatellite data. This indicates that great care must be taken to 
ensure that SNP markers are not linked before assessing significance of a value
...
the simulations. We do not know, for example, what effect selection or
population subdivision would have on inference of $\bar{r}_d$. While we were
...
effect we see is not due to higher average mutation rate. Additionally, because
of the low number of alleles per locus, there was a higher chance of homoplasy
in our simulations. This, however was most likely beneficial to our analysis as
our results show that low allelic diversity can lead to negative $\bar{r}_d$ 
values, which we have seen in data from purely clonal organisms.
