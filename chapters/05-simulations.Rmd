...
In addition to genotypic evenness, we additionally calculated mean allelic 
evenness $E_{5A} = (1/m) \sum E_{5l}$ where *m* is the number of loci and
$E_{5l}$ is the evenness of the alleles at locus *l*.
