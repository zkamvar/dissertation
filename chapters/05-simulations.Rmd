...
*Puccinia graminis* f.sp. *tritici* (Les Szabo, pers. comm.). 
...
Main points:
 ...
 - Ignoring linkage when doing permutation tests will show significant effects
   even if none exists.
 - It is important not to rely solely on $\bar{r}_d$ to declare a population clonal or sexual. The researcher must understand the biology of the organism. Example in *P. ramorum* [@kamvar2015spatial] and (Les Szabo, Pers. Comm.)
