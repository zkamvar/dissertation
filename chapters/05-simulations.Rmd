...
rate of 1e-5 between adjacent loci using the `Recombinator()` operator in simuPOP.
...
explanatory power of a method by simultaneously assessing the true positive fraction of tests
to a false positive fraction along a gradient of thresholds of increasing leniency [@metz1978basic]. 
...
Each curve was constructed by assessing the ROC over values of $\alpha$ in
