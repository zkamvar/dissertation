...
De Meeûx & Balloux [-@de2004clonal] investigated the effect of increasing levels of sexual
...
sensitivity of this test can be seen as the fraction of significant results
...
and the one with the smallest mesh size is on the bottom and pour both orange and
...
a threshold value in [0, 1]. Randomly mating populations are simulated with a sex
...
hierarchically by rate of sexual reproduction (< 1) and a unique seed was used to
...
resembles a correlation coefficient (equation \@ref(eq:rd)). De Meeûx & Balloux [-@de2004clonal]
...
sample sizes, and thus also decreases with clone-correction as sample size is by definition reduced when clone-correcting. More importantly,
...
values of $\bar{r}_d$ have been observed for pathogens that are well studied and known to
...
reflect microsatellite markers that would be selected for typical population genetic
...
sexual reproduction within the population
