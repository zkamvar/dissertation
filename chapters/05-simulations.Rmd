...
[@Nei:1978], calculated mean allelic evenness $E_{5A} = (1/m) \sum E_{5l}$ where
...
declared to be clonal. Standard practice for analyzing microbial populations is
...
size, rate of sexual reproduction, mutation rate homogeneity, and clone-
correction affect this method's sensitivity and specificity.
...
giving us a total of 1200 total populations for analysis.
