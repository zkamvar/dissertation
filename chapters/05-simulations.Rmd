...
*poppr* version 2.2.1 on full and clone-corrected data sets [@R2016; @kamvar2014poppr; @kamvar2015novel]. All downstream
...
0.01. The area under the ROC curves was calculated using the `auc()` function
in the R package *flux* version 0.3-0 [@jurasinski2014flux]. 
