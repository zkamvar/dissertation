...
if (LATEX){
  library("xtable") 
  subcap    <- "Summary table shown as it would appear in the R console
  ...
  [@Grunwald:2003]."
  subcap    <- beaverdown::render_caption(subcap, figname = "popprtabsub2", to = TO)
  subcap    <- gsub("\\\\", "\\\\\\\\", subcap)
...
```{r, poppr1, echo = FALSE, fig.cap = cap1, fig.scap = scap1}
...
```{r, poppr2, echo = FALSE, fig.cap = cap2, fig.scap = scap2}
...
```{r, poppr3, echo = FALSE, fig.cap = cap3, fig.scap = scap3}
...
```{r, poppr4, echo = FALSE, fig.cap = cap4, fig.scap = scap4}
